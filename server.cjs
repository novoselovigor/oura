...
Keep your analysis highly professional, insightful, scientifically accurate, motivating, and written completely in Russian. Avoid generic advice (such as "get 8 hours of sleep") and instead reference their specific numbers and days (e.g. "On 2026-05-25, your temperature spiked +0.6\xB0C and HRV dropped, indicating...").
`;
